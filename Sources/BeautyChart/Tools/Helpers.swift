...
public struct Colors {
    public static let LightGreen: Color = Color(hexString: "#E2FAE7")
    public static let LightGreenAccent: Color = Color(hexString: "#72BF82")

    public static let LightBlue: Color = Color(hexString: "#EEF1FF")
    public static let LightBlueAccent: Color = Color(hexString: "#4266E8")

    public static let LightPink: Color = Color(hexString: "#FCECEA")
    public static let LightPinkAccent: Color = Color(hexString: "#E1614C")
